			...
			uniform float uRedVal;
			uniform float uGreenVal;
			uniform float uBlueVal;
			...
			float red = uRedVal - noise;
			float green = uGreenVal - noise;
			float blue = uBlueVal - noise;
    		gl_FragColor = vec4(red, green ,blue, strength * uAlpha);
			}